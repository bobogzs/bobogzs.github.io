...
!function () {
  ...
  if (e.src = i >= 3 && i <= 5 ? "/img/sakura/YKGxV71kMg2wsbe.webp" : i >= 6 && i <= 8 ? "/img/sakura/Xx5uU1KAbkLoN82.webp" : i >= 9 && i <= 11 ? "/img/sakura/ijvoGYa7SLCrBOu.webp" : "/img/sakura/uqL2TsraQVWt3kA.webp",
    ...
    function a() {
      if (n) {
        var e = document.getElementById("canvas_sakura");
        ...
        !function () {
          ...
          a = document.getElementById("canvas_sakura");
          n = !0,
    ...
    e.onload = function () {
      ...
      window.onresize = function () {
        let t = document.getElementById("canvas_sakura");
